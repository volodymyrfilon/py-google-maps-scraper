        ...
        for search_for_index, search_for in enumerate(search_list):
            ...
            for listing in listings:
                try:
                    ...
                    name_attribute = listing.get_attribute(name_attibute)
                    
                    if name_attribute is not None and len(name_attribute) >= 1:
                        business.name = name_attribute
                    else:
                        business.name = ""
...
if __name__ == "__main__":
    print("###############################")
    print("####### @volodymyrfilon #######")
    print("###### Google Maps Parser #####")
    print("###############################")
    main()
